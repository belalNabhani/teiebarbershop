        ...
        <div className="row visible">
          <div className="col-md-8 col-md-offset-2">
            ...
            <p className="subtitle colored">
              Vi tilbyr et bredt av ulike tjenester. Få klassisk hårklipp og
              skjegg trim.
            </p>
        ...
        <div className="row visible">
          <div className="col-sm-4">
            <div className="horizontal-border fadeInUp">
              ...
              <p className="textfeat">
                Velg den beste stilen for hodeformen, og vi vil gi deg den
                perfekte klipp til å bli lagt merke til.
              </p>
              <br />
              <p>Hårklipp: 450 kr</p>
              <p>Skin fade: 500 kr </p>
              <p>Taper fade: 500 kr </p>
              <p>Maskinklip(Hele hodet uten form): 300 kr</p>
              <p>Hårklipp + Skjegg: 850 kr </p>
            </div>
          </div>
          <div className="col-sm-4">
            <div className="horizontal-border fadeInUp">
              ...
              <div className="voffset30" />
              <p className="textfeat">
                Få et komplett skjegg trim og gi det en ren, naturlig stil.
              </p>
              <br />
          ...
          <div className="col-sm-4">
            <div className="horizontal-border fadeInUp">
              ...
              <div className="voffset30" />
              <p className="textfeat">
                For best resultat kombinerer vi moderne og tradisjonelle
                metoder.
              </p>
              <br />
              <p>Hot towel shave</p>
              <p>Full barbering: 400 kr</p>
              <p>Hodet + Skjegg: 800 kr</p>
              <br />
            </div>
          </div>
        </div>
        ...
        <div className="row visible">
          <div className="col-sm-4">
            <div className="horizontal-border fadeInUp">
              ...
              <div className="voffset30" />
              <p className="textfeat">
                Du kan kjøpe Gavekort og velge behandlingen
              </p>
              <br />
              <br />
              <br />
          ...
          <div className="col-sm-4">
            <div className="horizontal-border fadeInUp">
              ...
              <div className="voffset30" />
              <p className="textfeat">
                Vi kan fjerne hår som plager deg i ansiktet og øre med voks
                eller tråd.
              </p>
              <br />
              <p>Hår vask: 75 kr</p>
              <p>Fjerne hår på ører: 125 kr</p>
              <p>Fjerne hår i nese: 125 kr</p>
              <p>Fjerne hår på ansikt: 250 kr</p>
              <p>Øyenbryn med tråd: 100 kr</p>
              <p>Full Pakke: 375 kr</p>
            </div>
          </div>
          <div className="col-sm-4">
            <div className="horizontal-border fadeInUp">
              ...
              <div className="voffset30" />
              <p className="textfeat">Alder fra 5 år til 12 år: 375 kr</p>
              <p className="textfeat">Alder fra 13 år til 15 år: 425 kr</p>
              <br />
              <br />
              <br />
              <br />
